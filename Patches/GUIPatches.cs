    ...
    public static void Postfix(XmlDocument doc, XmlReader reader, bool preserveWhitespace)
    {
        ...
        if (BasicOverhaulGlobalConfig.Instance?.EnableInventoryScreenFilters == true && reader?.BaseURI?.Contains("Inventory") == true)
        {
            ...
            if (node != null)
            {
                ...
                if (beforeNode != null)
                {
                    int[] marginTops = new []{ 110, 0, 0 };
                    for (int i = 0; i < 3; i++)
                    {
                        marginTops[i] = 110 + (27 * i);
                    }
                    string[] inventoryVMNodes = 
                    {
                        $"<PartyFilterController HorizontalAlignment=\"Left\" VerticalAlignment=\"Top\" MarginTop=\"{marginTops[0]}\" MarginLeft=\"!SidePanel.Width\" PositionXOffset=\"22\" Parameter.Height=\"20\" DataSource=\"{{FilterTypeLeft}}\" />",
                        $"<PartyFilterController HorizontalAlignment=\"Left\" VerticalAlignment=\"Top\" MarginTop=\"{marginTops[1]}\" MarginLeft=\"!SidePanel.Width\" PositionXOffset=\"22\" Parameter.Height=\"20\" DataSource=\"{{FilterTierLeft}}\"/>",
                        $"<PartyFilterController HorizontalAlignment=\"Left\" VerticalAlignment=\"Top\" MarginTop=\"{marginTops[2]}\" MarginLeft=\"!SidePanel.Width\" PositionXOffset=\"22\" Parameter.Height=\"20\" DataSource=\"{{FilterCultureLeft}}\" />",
                        $"<PartyFilterController HorizontalAlignment=\"Right\" VerticalAlignment=\"Top\" MarginTop=\"{marginTops[0]}\" MarginRight=\"!SidePanel.Width\" PositionXOffset=\"-22\" Parameter.Height=\"20\" DataSource=\"{{FilterTypeRight}}\" />",
                        $"<PartyFilterController HorizontalAlignment=\"Right\" VerticalAlignment=\"Top\" MarginTop=\"{marginTops[1]}\" MarginRight=\"!SidePanel.Width\" PositionXOffset=\"-22\" Parameter.Height=\"20\" DataSource=\"{{FilterTierRight}}\"/>",
                        $"<PartyFilterController HorizontalAlignment=\"Right\" VerticalAlignment=\"Top\" MarginTop=\"{marginTops[2]}\" MarginRight=\"!SidePanel.Width\" PositionXOffset=\"-22\" Parameter.Height=\"20\" DataSource=\"{{FilterCultureRight}}\" />",
                        "<ButtonWidget Id=\"DoneButtonWidgetLeft\" Command.Click=\"ExecuteSearchActionLeft\" HorizontalAlignment=\"Left\" DoNotPassEventsToChildren=\"true\" WidthSizePolicy=\"Fixed\" HeightSizePolicy=\"Fixed\" SuggestedWidth=\"120\" SuggestedHeight=\"25\" PositionXOffset=\"600\" PositionYOffset=\"80\" Brush=\"Quest.Sorting.Dropdown.Center.Small\" GamepadNavigationIndex=\"0\"> <Children> <TextWidget WidthSizePolicy=\"CoverChildren\" HeightSizePolicy=\"Fixed\" SuggestedHeight=\"40\" MarginLeft=\"30\" MarginRight=\"50\" MaxWidth=\"380\" VerticalAlignment=\"Center\" Brush=\"Popup.Button.Text\" Text=\"@ButtonOkLabel\" /> </Children> </ButtonWidget>",
                        "<ButtonWidget Id=\"DoneButtonWidgetRight\" Command.Click=\"ExecuteSearchActionRight\" HorizontalAlignment=\"Right\" DoNotPassEventsToChildren=\"true\" WidthSizePolicy=\"Fixed\" HeightSizePolicy=\"Fixed\" SuggestedWidth=\"120\" SuggestedHeight=\"25\" PositionXOffset=\"-600\" PositionYOffset=\"80\" Brush=\"Quest.Sorting.Dropdown.Center.Small\" GamepadNavigationIndex=\"0\"> <Children> <TextWidget WidthSizePolicy=\"CoverChildren\" HeightSizePolicy=\"Fixed\" SuggestedHeight=\"40\" MarginLeft=\"30\" MarginRight=\"50\" MaxWidth=\"380\" VerticalAlignment=\"Center\" Brush=\"Popup.Button.Text\" Text=\"@ButtonOkLabel\" /> </Children> </ButtonWidget>"
                    };
